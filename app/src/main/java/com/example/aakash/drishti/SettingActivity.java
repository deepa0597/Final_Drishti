            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(!image.equals("default"))
                    ...
                    Picasso.with(SettingActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE).
                            placeholder(R.drawable.ic_users).into(mCircleImageView, new Callback() {
                        @Override
                        ...
                        @Override
                        public void onError() {
                            Picasso.with(SettingActivity.this).load(image).placeholder(R.drawable.ic_users).into(mCircleImageView);
                        }
                    });

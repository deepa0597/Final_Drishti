    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sr.setRecognitionListener(new RecognitionListener() {
            ...
            public void onResults(Bundle bundle) {
                ...
                if(matches != null)
                    mMessageView.setText(matches.get(0));
            }
        ...
        mChatAddButton.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                switch(motionEvent.getAction())
                {
                    case MotionEvent.ACTION_UP:
                        mMessageView.setHint("Input here");
                        sr.stopListening();
                        break;
                    case MotionEvent.ACTION_DOWN:
                        mMessageView.setText("");
                        mMessageView.setHint("Listening");
                        sr.startListening(mSpeechRecintent);
                        break;
        ...
        mRootReference.child("users").child(mChatUser).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(ChatActivity.this).load(imageValue).placeholder(R.drawable.ic_users).into(mUserImage);

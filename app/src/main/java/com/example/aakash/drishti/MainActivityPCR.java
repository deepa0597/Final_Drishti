...
public class MainActivityPCR extends AppCompatActivity {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder=new AlertDialog.Builder(MainActivityPCR.this);
        builder.setMessage("Really Exit ??");
        builder.setTitle("Exit");
        builder.setCancelable(false);
        builder.setPositiveButton("Ok",new MainActivityPCR.MyListener());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.settings){
            Intent intent=new Intent(MainActivityPCR.this,SettingActivity.class);
            startActivity(intent);
        }
        if(item.getItemId()==R.id.allUsers){
            Intent intent=new Intent(MainActivityPCR.this,UserActivity.class);
            startActivity(intent);
        }
            ...
            mDatabaseReference.child(mauth.getCurrentUser().getUid()).child("online").setValue(ServerValue.TIMESTAMP).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(MainActivityPCR.this, "Try again..", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void startfn(){
        Intent intent = new Intent(MainActivityPCR.this,LoginActivity.class);
        startActivity(intent);
        finish();
    }
}
